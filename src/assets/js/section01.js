...
gsap.set('.intro02 > .intro__image', { opacity: 0, y: 10 }); //섭 타이틀
...
setTimeout(() => {
  ...
  tl.to(
    '.intro01 .intro__image .introImg02',
    { opacity: 1, x: 0, rotate: 0, duration: 1, ease: Power3.easeInOut },
    'ee +=3',
  );
  ...
  tl.to(
    '.intro01 .intro__image .introImg01',
    { opacity: 1, x: 0, y: 0, scale: 1, duration: 1, rotate: 270, ease: 'elastic' },
    'ee +=1',
  );
  tl.to(
    '.intro01 .intro__image .introImg04',
    { opacity: 1, x: 0, scale: 1, duration: 1, rotate: 0, ease: Power3.easeInOut },
    'ee +=4',
  );
  tl.to('.intro__title > h2', { opacity: 1, y: 0, duration: 2, ease: 'elastic' }, 'ee +=2');
  tl.to('.intro02 > .intro__image', { opacity: 1, y: 0, duration: 2, ease: 'elastic' }, 'ee +=2');
}, 1000);
